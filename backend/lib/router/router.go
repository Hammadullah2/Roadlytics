...
// WebSocket is intentionally removed — the Vercel-deployed backend is
// serverless and cannot maintain persistent connections.  Frontend job
// tracking uses Supabase Realtime instead.
