...
// GeoJSONUpload tracks a user-submitted GeoJSON file stored in Supabase Storage.
type GeoJSONUpload struct {
...
// SegmentationResult stores the GeoJSON output of road segmentation.
type SegmentationResult struct {
	ID          string          `json:"id" db:"id"`
	JobID       string          `json:"job_id" db:"job_id"`
	GeoJSONData json.RawMessage `json:"geojson_data" db:"geojson_data"`
...
type ConnectivityGraph struct {
	ID        string          `json:"id" db:"id"`
	JobID     string          `json:"job_id" db:"job_id"`
	GraphData json.RawMessage `json:"graph_data" db:"graph_data"`
